...
def _patch_extractor_kwargs(monkeypatch):
    """Allow DocumentExtractor to accept extra keyword arguments the router passes."""
    from services.document_extractor import DocumentExtractor

    _orig_init = DocumentExtractor.__init__

    def _patched_init(self, connection_factory, *, jsonifier=None, ocr_preprocessor=None,
                      layout_parser=None, **_kwargs):
        _orig_init(self, connection_factory, jsonifier=jsonifier,
                   ocr_preprocessor=ocr_preprocessor, layout_parser=layout_parser)

    monkeypatch.setattr(DocumentExtractor, "__init__", _patched_init)
